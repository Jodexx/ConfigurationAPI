package com.jodexindustries.configuration.file;
...
import com.jodexindustries.configuration.Configuration;
import com.jodexindustries.configuration.ConfigurationSection;
import com.jodexindustries.configuration.InvalidConfigurationException;
import com.jodexindustries.configuration.serialization.ConfigurationSerialization;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(@NotNull File file) {
        ...
        try {
            ...
            Logger.getLogger("ConfigAPI").log(Level.SEVERE, "Cannot load " + file, ex);
        }
    ...
    public static YamlConfiguration loadConfiguration(@NotNull Reader reader) {
        ...
        try {
            ...
            Logger.getLogger("ConfigAPI").log(Level.SEVERE, "Cannot load configuration from stream", ex);
        }
